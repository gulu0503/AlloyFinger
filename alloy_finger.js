...
; (function () {
	...
	var AlloyFinger = function (el, option) {
		...
		this.element.on('pointerdown', this.start);
		document.body.addEventListener("touchend", this.end, false);
		this.element.on('pointerupoutside', this.cancel);
		this.element.on('pointermove', this.move);
	...
	AlloyFinger.prototype = {
		...
		move: function (evt) {
			...
			evt.preventDefault();
			if (!evt.touches) return;
			if (!this.element.dragging) return;
			var preV = this.preV,
				len = evt.touches.length,
